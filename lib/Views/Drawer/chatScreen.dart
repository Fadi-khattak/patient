...
import 'package:patient/Controllers/ChatController.dart';
import 'package:patient/Models/AppointmnetModel.dart';
import 'package:patient/Models/ChatModel.dart';
        ...
        Column(
          ...
          children: [
            ...
            Align(
              ...
              child: Container(
                child:
                Text(model.msg,style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
              ),
            ),
            SizedBox(height: 10,),
            Align(
